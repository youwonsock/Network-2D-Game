...
class PacketManager
{
	...
	{		
		...
		onRecv.Add((ushort)MsgId.SEquipItem, MakePacket<S_EquipItem>);
		handler.Add((ushort)MsgId.SEquipItem, PacketHandler.S_EquipItemHandler);		
		onRecv.Add((ushort)MsgId.SChangeStat, MakePacket<S_ChangeStat>);
		handler.Add((ushort)MsgId.SChangeStat, PacketHandler.S_ChangeStatHandler);		
		onRecv.Add((ushort)MsgId.SPing, MakePacket<S_Ping>);
		handler.Add((ushort)MsgId.SPing, PacketHandler.S_PingHandler);
	}
